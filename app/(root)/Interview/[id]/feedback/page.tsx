...
//       {/* 🚀 NEW: ML Insights - Dual AI Validation System */}
//       {feedback && (feedback as any).ml_score !== undefined && (
//         <MLInsights
//           geminiScore={
//             (feedback as any).gemini_score || feedback.totalScore || 0
//           }
//           mlScore={(feedback as any).ml_score || 0}
//           agreementLevel={(feedback as any).agreement_level || "N/A"}
//           difference={(feedback as any).difference || 0}
//           confidence={(feedback as any).confidence || "N/A"}
//         />
//       )}
